...
Here both the query for finding the contacts icon and the query for finding contacts frame can be confusing in terms of how should it be applied to a custom app.
...
When this file is run against the app, it displayes three failing assertions. It is a good practice to start with failing test cases, and to fix them one by one until all of them will be successful. I start with the test case \verb|test_cancel_login|:
